      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Manage your accepted caregivers and their services
          </p>
        </div>
        ...
        <div className="space-y-4">
          {applications
            ...
            .map((app) => (
              <div
                key={app.id}
                className="bg-card rounded-xl p-6 card-shadow card-lift"
              >
                <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  <div className="flex lg:flex-col gap-2 lg:min-w-[160px]">
                    <Button
                      ...
                      onClick={() => navigate(`/family/caregiver/profile/${app.id}`)}
                    >
                      View Details
                    </Button>
