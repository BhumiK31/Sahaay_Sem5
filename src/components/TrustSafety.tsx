...
const TrustSafety = () => {
  ...
  return (
    <section id="trust-safety" className="section-padding bg-background">
      <div className="container-width">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-4 bg-card border border-accent-mint/20 rounded-[var(--radius-lg)] px-8 py-4 shadow-[var(--shadow-soft)]">
            <Shield className="w-8 h-8 text-accent-mint" />
            <div className="text-left">
              <p className="font-semibold text-foreground">Verified Safe Platform</p>
